    ...
    var Slide = function () {
        ...
        _createClass(Slide, [{
            ...
            value: function init() {
                ...
                document.getElementById("strs").innerHTML = "<a class='linker' href="+linkls[0]+"></a><a class='showbar' href='"+linkls[0]+"'>"+textls[0]+"</a>";
            ...
            value: function initAutoSwitch() {
                ...
                setInterval(function () {
                    ...
                    document.getElementById("strs").innerHTML = "<a class='linker' href="+linkls[page - 1]+' target="_blank"></a><a class='+"'showbar' href='"+linkls[page - 1]+"'>"+textls[page - 1]+"</a>";
                }, delay);
            }
        }, {
            key: 'doAnimation',
