    ...
    return function(t) {
        ...
        ***************************************************************************** */
        ...
        var o = i.__importDefault(n(8)),
            ...
            l = function() {
                function t(t) {
                    ...
                    n.crossDomain && (document.domain = "wemakeli.net.wm"), n.gamePlayer || "litePlayer" === n.playerKind ? (n.gamePlayer && (n.playerKind = "gamePlayer"), new r.default(n)) : new o.default(n)
                }
                return t.getCid = function(t, e) {
                    var n = {},
                        i = (t.p || 1) - 1;
                    window.show_bv ? n.bvid = t.bvid : n.aid = t.aid, s.default.ajax({
                        data: n,
                        method: "GET",
                        url: "//wemakeli.net.wm/api/x/web-interface/view.php",
                        async: !0,
                        withCredentials: !0
                    }).then((function(n) {
                        try {
        ...
        var i = {
            ...
            flashChecker: function() {
                ...
                if (/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()) && !/Edge/i.test(navigator.userAgent) || /Trident/i.test(navigator.userAgent)) try {
                    (e = window.ActiveXObject && new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash")) && (t = !0, e.GetVariable("$version"))
            ...
            html5Policy: function() {
                try {
                    ...
                    if (/Chrome\/\d+/i.test(navigator.userAgent)) {
                        if ((t = navigator.userAgent.match(/Chrome\/(\d+)/)) && parseInt(t[1], 10) >= 45) return !0
                    } else if (/Firefox\/\d+/i.test(navigator.userAgent)) {
                        if ((t = navigator.userAgent.match(/Firefox\/(\d+)/)) && parseInt(t[1], 10) >= 47) return !0
            ...
            parseConfig: function(t, e, n) {
                if ("enable_ssl_resolve" === e || "enable_ssl_stream" === e) t[e] = "" !== n && 0 == n ? 0 : 1;
                else if ("aid" === e || "cid" === e) t[e] = n;
                else if ("bvid" === e) t[e] = n || "";
                else if ("player_type" === e || "pre_ad" === e) t[e] = n || "";
                else switch (e) {
                    case "danmaku":
                        t[e] = "" !== n && 0 == n ? "" : 1;
                        break;
                    ...
                    case "has_danmaku":
                        ...
                        break;
                    case "urlparam":
                        t.extra_params = n ? decodeURIComponent(n) : "", t[e] = n ? n + encodeURIComponent("&season_type=") + this.getUrlValue("season_type") : "";
                        break;
                    case "p":
            ...
            defaultSearch: function() {
                var t, e = this,
                    ...
                    i = {},
                    o = [];
                return -1 !== n.indexOf("?") && (o = n.slice(1).split("&")), ["aid", "bvid", "cid", "danmaku", "autoplay", "as_wide", "player_type", "pre_ad", "enable_ssl", "enable_ssl_resolve", "enable_ssl_stream", "urlparam", "p"].forEach((function(t) {
                    i[t] || e.parseConfig(i, t, "")
                })), o.forEach((function(n) {
                    t = n.split("="), e.parseConfig(i, t[0], t[1])
                })), i
            },
            loadScript: function(t, e) {
                ...
                return i.onload = function() {
                    ...
                    t.error && t.error()
                }, i.src = t.url, n.document.head.appendChild(i), i
            },
            objToStr: function(t) {
                var e = "";
            ...
            ajax: function(t) {
                return new Promise((function(e, n) {
                    ...
                    if (a.withCredentials = t.withCredentials || !1, "POST" === o) a.open(o, t.url, r), a.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), a.send(s);
                    else if ("GET" === o) {
                        var l = t.url + "?" + s;
                        a.open(o, l, r), a.send()
                    } else a.open(o, t.url), a.send();
        ...
        Object.defineProperty(e, "__esModule", {
            ...
            hash: "32ceeed",
            branch: "master",
            lastModefied: "2020-06-29T05:09:04.408Z"
        }
    }, function(t, e, n) {
        "use strict";
        var i, o = function() {
        ...
        function w(t, e) {
            ...
            } else n = c(e), i = p.bind(null, n, e), o = function() {
                ! function(t) {
        ...
        (e = n(5)(!1)).push([t.i, "body,html{overflow:hidden}#bofqi,.player,body,html{margin:0;padding:0;width:100%;height:100%}.player .bilibili-player{-webkit-box-shadow:none;box-shadow:none}.player .bilibili-player-video-bottom-area .bilibili-player-video-sendbar{-webkit-box-sizing:border-box;box-sizing:border-box;border-left:1.5px solid #f4f4f4;border-bottom:1.5px solid #f4f4f4;border-right:1.5px solid #f4f4f4}.player-with-auxiliary{display:-webkit-box;display:-ms-flexbox;display:flex}.player-with-auxiliary .player{-webkit-box-flex:1;-ms-flex:1;flex:1}.player-with-auxiliary .danmaku-box{width:320px;margin-left:30px}.player-mode-widescreen .danmaku-box{display:none}", ""]), t.exports = e
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var i = n(0).__importDefault(n(9)),
            o = function() {
                function t(t) {
                    this.config = t, this.globalEvents(), this.init()
                }
                return t.prototype.globalEvents = function() {
                    ...
                    window.getPlayList = function() {
                        ...
                        showPay: function() {
                            if (t.config && "0" === t.config.type) window.open("https://wemakeli.net.wm/cheese/play/ep" + t.config.episodeId);
                            else {
                                var e = window.show_bv ? window.bvid : "av" + window.aid;
                                window.open("https://wemakeli.net.wm/" + e)
                            }
                        },
                        showVipPay: function() {
                            if (t.config && "0" === t.config.type) window.open("https://wemakeli.net.wm/cheese/play/ep" + t.config.episodeId);
                    ...
                    try {
                        window.parent.GrayManager = window.GrayManager, window.heimu = window.parent.heimu = void 0, window.parent.PlayerAgent && (window.PlayerAgent = window.parent.PlayerAgent), window.elecPlugin = window.parent.elecPlugin;
        ...
        var i = n(0),
            ...
            s = function() {
                function t(t) {
                    this.plurl = "//wemakeli.net.wm/api/x/playlist/video/toview?jsonp=jsonp&pid=", this.allow = !0, this.config = t, this.preinit(), this.init()
                }
                return t.prototype.preinit = function() {
                    ...
                    if (this.allow) {
                        var e = this.config;
                        if ("1" === e.auxiliary && (document.getElementsByClassName("player")[0].insertAdjacentHTML("afterend", '<div id="danmukuBox" class="danmaku-box"><div class="danmaku-wrap"></div></div>'), document.body.classList.add("player-with-auxiliary")), !this.onlyH5())
                            if (e.playlistId) this.loadPlayer(e);
                            else {
                                var n = window.getPlayList();
                                if (e.playlist && n) {
                                    var i = n && n.data,
                                        o = JSON.stringify(n);
                                    e.aid = e.aid || i && i.list && i.list[0].aid, e.bvid = e.bvid || i && i.list && i.list[0].bvid, e.cid = e.cid || i && i.list && i.list[0].pages[0].cid, e.playlist = encodeURIComponent(o), e.playlist_order = e.playlist_order, this.loadPlayer(e)
                                } else e.cid ? this.loadPlayer(e) : r.default.getCid(e, (function(e) {
                                    t.loadPlayer(e)
                                }))
                            }
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            var o = t && t.data,
                                r = JSON.stringify(t);
                            n.aid = i("aid") || o && o.list && o.list[0].aid, n.cid = i("cid") || o && o.list && o.list[0].pages[0].cid, n.playlist = encodeURIComponent(r), n.playlist_order = i("playlist_order"), e.loadPlayer(n)
                        }
                    })
                    ...
                    n.addEventListener("load", (function() {
                        ...
                        t.loadPlayer(e)
                    })), n.open("GET", "//wemakeli.net.wm/api/x/web-interface/view.php?aid=" + o.default.getUrlValue("aid"), !0), n.send()
                }, t.prototype.loadPlayer = function(t) {
                    var e, n = [];
                    for (var i in t)({}).hasOwnProperty.call(t, i) && n.push(i + "=" + (null !== (e = t[i]) && void 0 !== e ? e : ""));
                    window.EmbedPlayer && window.EmbedPlayer("player", "", n.join("&")), window.parent !== window && this.setParentPlayer()
                }, t.prototype.setParentPlayer = function() {
                    var t = this;
                    if (window.player) try {
                        window.parent.player = window.player, "function" == typeof window.parent.Html5IframeInitialized && window.parent.Html5IframeInitialized()
                    } catch (t) {} else setTimeout((function() {
                        t.setParentPlayer()
                    }), 200)
                }, t.prototype.onlyH5 = function() {
                    return !(!this.config.musth5 || (!o.default.flashChecker() || o.default.html5Policy()) && o.default.html5Checker() || (this.mustH5(), 0))
        ...
        var i = n(0),
            ...
            l = function() {
                function t(t) {
                    this.retry = 3, this.config = t, this.defaulth5 = !0, this.globalEvents(), this.preinit(), this.loadPlayer()
                }
                return t.prototype.loadPlayer = function() {
                    ...
                    var t, e = this;
                    if (window.location.ancestorOrigins) t = window.location.ancestorOrigins[0];
                    else {
                    ...
                    this.options = i.__assign({
                        ...
                        gamePlayer: {
                            url: "//wemakeli.net.wm/active/biliplayer/player.bilibili.com/main/html5/player.js",
                            flashUrl: "//wemakeli.net.wm/active/biliplayer/player.bilibili.com/tools/gameplayer/GamePlayer.swf"
                        },
                        litePlayer: {
                            url: "//wemakeli.net.wm/active/biliplayer/player.bilibili.com/main/html5/outer/liteplayer.min.js",
                            flashUrl: "//wemakeli.net.wm/active/biliplayer/player.bilibili.com/main/flash/outer/miniloader.swf"
                        }
                    }[this.config.playerKind]), r.default.flashChecker() && !r.default.html5Policy() || !r.default.html5Checker() || "flash" === r.default.getUrlValue("ptype") ? this.defaulth5 = !1 : this.defaulth5 = !0
                }, t.prototype.init = function() {
                    var t = this;
                    ...
                    var t = this;
                    if (this.defaulth5) this.config.element = document.getElementById(this.options.id), this.player = new window.bilibiliPlayer(this.config);
                    else {
                        if (window.gameQuickLogin = function() {
                                !r.default.version.mobile || r.default.version.iPad ? t.getScript("biliQuickLogin", "//static.hdslb.com/account/bili_quick_login.js", (function() {
                                    window.biliQuickLogin((function() {
                                        document.getElementById(t.options.id).mukio_reloadAccess(), window.BILIMessage(JSON.stringify({
                                            type: "login",
                                            value: !0
                                        }))
                                    }))
                                })) : window.location.href = "https://passport.bilibili.com/login"
                            }, !r.default.flashChecker()) return void this.showTips();
                        this.config.hasDanmaku = this.config.hasDanmaku ? 0 : "1", this.config.autoplay = this.config.autoplay ? 1 : 0;
                        var e = {
                            aid: this.config.aid,
                    ...
                    $(this.options.wrapClass).html('<div id="' + e + '" class="flash-player"></div>'), window.swfobject.embedSWF(this.options.flashUrl, e, "100%", "100%", "0", "", t, {
                        bgcolor: "#ffffff",
                    ...
                    this.defaulth5 && (t.btnList[0].theme = "white", t.btnList.push({
                        title: "使用HTML5播放器",
                        type: "html5",
                        theme: "blue",
                        onClick: function(t) {
                    ...
                    window[t] ? "function" == typeof n && n() : $.ajax({
                        ...
                        error: function() {
                            i.retry > -1 ? (i.retry -= 1, setTimeout((function() {
                                i.getScript(t, e, n)
        ...
        var o = i.__importDefault(n(14)),
            r = function() {
                ...
                return t.prototype.destroy = function() {
                    return this.noFlashTips && this.noFlashTips.destroy(), this
                }, t
            }();
        e.default = r
    }, function(t, e, n) {
        ...
        var i = n(0).__importDefault(n(15)),
            o = function() {
                function t(t, e) {
                    if (!(t && t instanceof Element)) throw new Error("Container Error");
                    this.container = t, this.config = i.default.extend({}, {
                        ...
                        miniColor: "#fff"
                    }, e), this.destroyStatus = !1, this.REMOVE_INTERVAL = 0, this.onMini = !1, this.callbackMap = {}, this.prefix = "bp-no-flash-tips";
                    try {
                        this.init()
                    } catch (t) {}
                }
                return t.prototype.init = function() {
                    var t = this.config;
                    this.addContainerPosition(), this.tips = document.createElement("div"), this.tips.className = "" + this.prefix, this.tips.style.backgroundColor = t.backgroundColor, this.tips.innerHTML = '\n            <div class="' + this.prefix + '-content">\n                 <div class="' + this.prefix + '-missing-image">\n                    <img src="//s1.hdslb.com/bfs/static/player/img/missing.png">\n                 </div>\n                 <div class="' + this.prefix + '-info" style="color:' + t.msgColor + ";font-size:" + t.msgSize + 'px;">\n                    ' + t.msg + '\n                </div>\n                 <div class="' + this.prefix + '-btn-content">\n                    ' + this.createBtns() + '\n                </div>\n            </div>    \n            <div class="' + this.prefix + '-mini-info" style="color:' + t.miniColor + '">' + t.miniMsg + "</div>", this.container.appendChild(this.tips), this.bindEvents()
                    ...
                    var o = i.default.bindElemResize(e, (function(e, n) {
                        ...
                        } else e > 400 && t.onMini && (t.onMini = !1, t.tips.className = "" + t.prefix)
                    }));
                    "function" == typeof o && o()
                    ...
                    return n instanceof Array && n.length && n.forEach((function(r, a) {
                        ...
                        if ("flash" === r.type) o += '<a href="https://www.adobe.com/go/getflashplayer" target="_blank" class="' + t.prefix + "-btn " + t.prefix + "-flash-btn " + t.prefix + "-btn-" + r.theme + '" style="' + s + '">' + r.title + "</a>";
                        else {
                            var l = i.default.getRandomID(12);
                            o += '<a id="' + l + '" href="javascript:;" class="' + t.prefix + "-btn " + t.prefix + "-btn-" + r.theme + '" style="' + s + '">' + r.title + "</a>", r.onClick && t.addCallback(l, r.onClick)
                        }
                    ...
                    t && "function" == typeof e && (this.callbackMap[t] || (this.callbackMap[t] = []), this.callbackMap[t].push(e))
                    ...
                    if (!this.destroyStatus) {
                        ...
                        e.className = n + " " + i + " " + n + "-destroying", this.callbackMap = {}, clearTimeout(this.REMOVE_INTERVAL), this.REMOVE_INTERVAL = window.setTimeout((function() {
        ...
        var i = {
            ...
            getRandomID: function(t) {
                void 0 === t && (t = 8);
                for (var e = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", n = "", i = 0; i < t; i++) n += e.charAt(Math.floor(Math.random() * e.length));
                return n
            },
            ...
            bindElemResize: function(t, e) {
                if (!t || !t.getBoundingClientRect) return !1;
                var n = 0,
                    i = 0;
                ...
                function o() {
                    var o = t.getBoundingClientRect(),
                        r = o.width,
                        a = o.height;
                    r === n && a === i || (n = r, i = a, "function" == typeof e && e(r, a))
                }
                return document.addEventListener("scroll", o), window.addEventListener("resize", o), o
            }
        };
        e.default = i
    }, function(t, e, n) {
        ...
        s.prototype.catch = function(t) {
        ...
        }, s.prototype.finally = i, s.all = function(t) {
            ...
            return new s((function(e, n) {
                ...
                for (var i = 0, o = t.length; i < o; i++) s.resolve(t[i]).then(e, n)
            }))
