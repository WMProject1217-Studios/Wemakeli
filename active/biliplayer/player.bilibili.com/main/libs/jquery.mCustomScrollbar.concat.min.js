...
(function(q, u) {
    if ("object" === typeof exports && "object" === typeof module) module.exports = u();
    else if ("function" === typeof define && define.amd) define([], u);
    else {
        u = u();
        for (var A in u)("object" === typeof exports ? exports : q)[A] = u[A]
    }
        ...
        (function(c) {
            (function() {
                var u = {
                    ...
                    E = !1,
                    L, n = "mCSB_dragger_onDrag mCSB_scrollTools_onDrag mCS_img_loaded mCS_disabled mCS_destroyed mCS_no_scrollbar mCS-autoHide mCS-dir-rtl mCS_no_scrollbar_y mCS_no_scrollbar_x mCS_y_hidden mCS_x_hidden mCSB_draggerContainer mCSB_buttonUp mCSB_buttonDown mCSB_buttonLeft mCSB_buttonRight".split(" "),
                    C = {
                        init: function(a) {
                            a = c.extend(!0, {}, u, a);
                            var d = I.call(this);
                            ...
                            "object" !== r(a.mouseWheel) &&
                                1 == a.mouseWheel && (a.mouseWheel = {
                                    enable: !0,
                                    scrollAmount: "auto",
                                    axis: "y",
                                    preventDefault: !1,
                                ...
                                if (!b.data("mCS")) {
                                    ...
                                    var g = c(this),
                                        ...
                                        p = ["<div id='mCSB_" +
                                            ...
                                            e.idx + "_dragger_horizontal' class='mCSB_dragger' style='position:absolute;'><div class='mCSB_dragger_bar' /></div><div class='mCSB_draggerRail' /></div></div>"
                                        ],
                                    ...
                                    "y" === l.axis || l.advanced.autoExpandHorizontalScroll ||
                                        v.css("width", ea(v));
                                    "outside" === l.scrollbarPosition ? ("static" === g.css("position") && g.css("position", "relative"), g.css("overflow", "visible"), B.addClass("mCSB_outside").after(p)) : (B.addClass("mCSB_inside").append(p), v.wrap(ma));
                                    l = c(this).data("mCS");
                                    g = l.opt;
                                    l = c(".mCSB_" + l.idx + "_scrollbar:first");
                                    p = U(g.scrollButtons.tabindex) ? "tabindex='" + g.scrollButtons.tabindex + "'" : "";
                                    p = ["<a href='#' class='" + n[13] + "' " + p + " />", "<a href='#' class='" + n[14] + "' " + p + " />", "<a href='#' class='" + n[15] + "' " + p + " />", "<a href='#' class='" +
                                        n[16] + "' " + p + " />"
                                    ];
                                    ...
                                    if (h.length) {
                                        ...
                                        if (f.advanced.autoExpandHorizontalScroll && "y" !== f.axis) {
                                            ...
                                            3 === f.advanced.autoExpandHorizontalScroll || 2 !== f.advanced.autoExpandHorizontalScroll && l > g.parent().width() ? g.css({
                                                ...
                                                width: Math.ceil(g[0].getBoundingClientRect().right +
                                                    .4) - Math.floor(g[0].getBoundingClientRect().left),
                                                "min-width": "100%",
                                                position: "relative"
                                            }).unwrap()
                                        }
                                        ...
                                        "x" !== k.axis && (e.overflowed[0] ? m[0].height() >
                                            m[0].parent().height() ? J.call(this) : (y(a, h[0].toString(), {
                                                dir: "y",
                                                dur: 0,
                                                overwrite: "none"
                                            }), e.contentReset.y = null) : (J.call(this), "y" === k.axis ? V.call(this) : "yx" === k.axis && e.overflowed[1] && y(a, h[1].toString(), {
                                                dir: "x",
                                                dur: 0,
                                                overwrite: "none"
                                            })));
                                        "y" !== k.axis && (e.overflowed[1] ? m[1].width() > m[1].parent().width() ? J.call(this) : (y(a, h[1].toString(), {
                                            ...
                                            dur: 0,
                                            overwrite: "none"
                                        }), e.contentReset.x = null) : (J.call(this), "x" === k.axis ? V.call(this) : "yx" === k.axis && e.overflowed[0] && y(a, h[0].toString(), {
                                            dir: "y",
                                            dur: 0,
                                            overwrite: "none"
                                        })));
                            ...
                            if ("undefined" !== typeof a && null != a) {
                                ...
                                return c(b).each(function() {
                                    ...
                                    if (b.data("mCS")) {
                                        ...
                                        f.moveDragger && (m[0] *= k.scrollRatio.y, m[1] *= k.scrollRatio.x);
                                        f.dur = oa() ? 0 : g;
                                        setTimeout(function() {
                                            null !== m[0] && "undefined" !== typeof m[0] && "x" !== h.axis && k.overflowed[0] && (f.dir =
                                                "y", f.overwrite = "all", y(b, m[0].toString(), f));
                                            null !== m[1] && "undefined" !== typeof m[1] && "y" !== h.axis && k.overflowed[1] && (f.dir = "x", f.overwrite = "none", y(b, m[1].toString(), f))
                                        }, f.timeout)
                                    }
                                })
                            }
                        ...
                        disable: function(a) {
                            ...
                            return c(d).each(function() {
                                var b = c(this);
                                b.data("mCS") && (b.data("mCS"), Y.call(this, "remove"), V.call(this), a && J.call(this), fa.call(this, !0), b.addClass(n[3]))
                            })
                        },
                        destroy: function() {
                            var a =
                    ...
                    I = function() {
                        return "object" !==
                            r(c(this)) || 1 > c(this).length ? ".mCustomScrollbar" : this
                    },
                    da = function(a) {
                    ...
                    W = function(a, d, b) {
                        ...
                        "active" === d ? (a.toggleClass(n[0] + " " + b), c.toggleClass(n[1]), a[0]._draggable = a[0]._draggable ? 0 : 1) : a[0]._draggable || ("hide" === d ? (a.removeClass(n[0]), c.removeClass(n[1])) : (a.addClass(n[0]), c.addClass(n[1])))
                    },
                    J = function() {
                        var a = c(this),
                            d = a.data("mCS"),
                            ...
                            h = [c("#mCSB_" + d.idx + "_dragger_vertical"), c("#mCSB_" +
                                d.idx + "_dragger_horizontal")];
                        G(a);
                        if ("x" !== b.axis && !d.overflowed[0] || "y" === b.axis && d.overflowed[0]) h[0].add(k).css("top", 0), y(a, "_resetY");
                        if ("y" !== b.axis && !d.overflowed[1] || "x" === b.axis && d.overflowed[1]) b = dx = 0, "rtl" === d.langDir && (b = e.width() - k.outerWidth(!1), dx = Math.abs(b / d.scrollRatio.x)), k.css("left", b), h[1].css("left", dx), y(a, "_resetX")
                    },
                    na = function() {
                        var a = c(this),
                            d = a.data("mCS"),
                            ...
                            if (b.mouseWheel.enable) {
                                ...
                                (function h() {
                                    e = setTimeout(function() {
                                        c.event.special.mousewheel ? (clearTimeout(e), sa.call(a[0])) : h()
                                    }, 100)
                                })()
                            }
                            ta.call(this);
                    ...
                    V = function() {
                        var a = c(this),
                            ...
                            k = c("#mCSB_" + d.idx + ",#mCSB_" + d.idx + "_container,#mCSB_" + d.idx + "_container_wrapper," + k + " ." + n[12] + ",#mCSB_" + d.idx + "_dragger_vertical,#mCSB_" +
                                d.idx + "_dragger_horizontal," + k + ">a"),
                        ...
                        d.bindEvents && (c(document).add(c(!N() || top.document)).unbind("." + e), k.each(function() {
                            c(this).unbind("." + e)
                        }), clearTimeout(a[0]._focusTimeout), F(a[0], "_focusTimeout"), clearTimeout(d.sequential.step), F(d.sequential, "step"), clearTimeout(h[0].onCompleteTimeout), F(h[0],
                            "onCompleteTimeout"), d.bindEvents = !1)
                    },
                    fa = function(a) {
                        var d = c(this),
                            b = d.data("mCS"),
                        ...
                        "x" !== e.axis && (b.overflowed[0] && !a ? (h[0].add(f[0]).add(h[0].children("a")).css("display", "block"), k.removeClass(n[8] + " " + n[10])) : (e.alwaysShowScrollbar ? (2 !== e.alwaysShowScrollbar &&
                            f[0].css("display", "none"), k.removeClass(n[10])) : (h[0].css("display", "none"), k.addClass(n[10])), k.addClass(n[8])));
                        "y" !== e.axis && (b.overflowed[1] && !a ? (h[1].add(f[1]).add(h[1].children("a")).css("display", "block"), k.removeClass(n[9] + " " + n[11])) : (e.alwaysShowScrollbar ? (2 !== e.alwaysShowScrollbar && f[1].css("display", "none"), k.removeClass(n[11])) : (h[1].css("display", "none"), k.addClass(n[11])), k.addClass(n[9])));
                    ...
                    t = function(a) {
                        ...
                        switch (d) {
                            ...
                            case "pointerup":
                            case "MSPointerUp":
                                return b ? [a.originalEvent.pageY - b[0] + e[0], a.originalEvent.pageX - b[1] + e[1], !1] : [a.originalEvent.pageY,
                                    a.originalEvent.pageX, !1
                                ];
                            case "touchstart":
                            case "touchmove":
                            case "touchend":
                                return d = a.originalEvent.touches[0] || a.originalEvent.changedTouches[0], b = a.originalEvent.touches.length || a.originalEvent.changedTouches.length, a.target.ownerDocument !== document ? [d.screenY, d.screenX, 1 < b] : [d.pageY, d.pageX, 1 < b];
                            default:
                    ...
                    pa = function() {
                        function a(a, c, l, k) {
                            ...
                            if (g.attr("id") === h[1]) {
                                ...
                                a = (g[0].offsetLeft -
                                    c + k) * b.scrollRatio.x
                            } else m = "y", a = (g[0].offsetTop - a + l) * b.scrollRatio.y;
                            y(d, a.toString(), {
                                dir: m,
                                drag: !0
                            })
                        ...
                        var d = c(this),
                            ...
                            n = e.advanced.extraDraggableSelectors ? c(!N() || top.document).add(c(e.advanced.extraDraggableSelectors)) :
                            c(!N() || top.document);
                        ...
                        c(document).add(n).bind("mousemove." + k + " pointermove." + k + " MSPointerMove." + k, function(b) {
                            ...
                            g && (W(g, "active", e.autoExpandScrollbar), g = null);
                            E = !1;
                    ...
                    qa = function() {
                        ...
                        function d(a) {
                            if (X(a) && !E && !t(a)[2] && (g.documentTouchScroll || a.preventDefault(), a.stopImmediatePropagation(), (!F || C) && v)) {
                                R = S();
                                var b = p.offset(),
                                    c = t(a)[0] - b.top,
                                    b = t(a)[1] - b.left;
                                ...
                                if (m.overflowed[0]) {
                                    ...
                                    d = 0 < M - c && c - M > -(d * m.scrollRatio.y) && (2 * q[3] < q[2] ||
                                        "yx" === g.axis)
                                }
                                if (m.overflowed[1]) {
                                ...
                                d || e ? (J || a.preventDefault(), C = 1) : (F = 1, f.addClass("mCS_touch_action"));
                                J && a.preventDefault();
                        ...
                        function e(a) {
                            if (X(a) && !E && !t(a)[2]) {
                                ...
                                if (!(30 < aa - R)) {
                                    ...
                                    H = "yx" ===
                                        g.axis ? [a[0], a[1]] : "x" === g.axis ? [null, a[1]] : [a[0], null];
                        ...
                        var f = c(this),
                            ...
                            F = void 0,
                            I = B.find("iframe"),
                            P = ["touchstart." + l + " pointerdown." + l + " MSPointerDown." + l, "touchmove." + l + " pointermove." + l + " MSPointerMove." + l, "touchend." +
                                l + " pointerup." + l + " MSPointerUp." + l
                            ],
                    ...
                    ra = function() {
                        ...
                        f.bind("mousedown." + h, function(a) {
                            ...
                            if (!L && g && (window.getSelection ? window.getSelection().toString() : document.selection && "Control" != document.selection.type && document.selection.createRange().text)) {
                                ...
                                c = t(c)[1] -
                                    d.left + f[0].offsetLeft;
                                0 < l && l < m.height() && 0 < c && c < m.width() ? k.step && a("off", null, "stepped") : ("x" !== e.axis && b.overflowed[0] && (0 > l ? a("on", 38) : l > m.height() && a("on", 40)), "y" !== e.axis && b.overflowed[1] && (0 > c ? a("on", 37) : c > m.width() && a("on", 39)))
                            }
                        }).bind("mouseup." + h + " dragend." + h, function(b) {
                            L || (g && (g = 0, a("off", null)), E = !1)
                        })
                    },
                    sa = function() {
                        function a(a, l) {
                            ...
                            if (!(-1 < c.inArray(m,
                                    g)) || -1 < c.inArray(m, v) && !c(k).is(":focus")) {
                                ...
                                if ("x" === e.axis || "x" === e.mouseWheel.axis) {
                                    ...
                                    l = "y" ===
                                        e.mouseWheel.axis ? a.deltaY || l : a.deltaX
                                } else k = "y", g = [Math.round(g * b.scrollRatio.y), parseInt(e.mouseWheel.scrollAmount)], n = "auto" !== e.mouseWheel.scrollAmount ? g[1] : g[0] >= h.height() ? .9 * h.height() : g[0], D = Math.abs(c("#mCSB_" + b.idx + "_container")[0].offsetTop), v = f[0][0].offsetTop, g = f[0].parent().height() - f[0].height(), l = a.deltaY || l;
                                if (("y" !== k || b.overflowed[0]) && ("x" !== k || b.overflowed[1])) {
                                    if (e.mouseWheel.invert || a.webkitDirectionInvertedFromDevice) l = -l;
                                    e.mouseWheel.normalizeDelta && (l = 0 > l ? -1 : 1);
                                    if (0 < l &&
                                        0 !== v || 0 > l && v !== g || e.mouseWheel.preventDefault) a.stopImmediatePropagation(), a.preventDefault();
                                    5 > a.deltaFactor && !e.mouseWheel.normalizeDelta && (n = a.deltaFactor, m = 17);
                                    y(d, (D - l * n).toString(), {
                                        dir: k,
                                        dur: m
                                    })
                        ...
                        if (c(this).data("mCS")) {
                            ...
                            m.length && m.each(function() {
                                c(this).bind("load", function() {
                                    N(this) && c(this.contentDocument ||
                                        this.contentWindow.document).bind("mousewheel." + k, function(b, c) {
                                        a(b, c)
                                    })
                                })
                            });
                    ...
                    N = function(a) {
                        ...
                        if (!1 !== d && void 0 !== ca[d]) return ca[d];
                        if (a) try {
                            var e = a.contentDocument || a.contentWindow.document;
                            b = e.body.innerHTML
                        } catch (k) {} else try {
                            e = top.document, b = e.body.innerHTML
                        } catch (k) {}
                        a = null !== b;
                        !1 !== d && (ca[d] = a);
                        return a
                    ...
                    ta = function() {
                        ...
                        c(".mCSB_" + d.idx + "_scrollbar ." + n[12]).bind("mousedown." + b + " touchstart." + b + " pointerdown." + b + " MSPointerDown." + b, function(a) {
                            ...
                            if (h && (h = 0, c(b.target).hasClass(n[12]) || c(b.target).hasClass("mCSB_draggerRail"))) {
                                G(a);
                                var f =
                                    c(this);
                    ...
                    va = function() {
                        ...
                        k.bind("focusin." + e,
                            function(d) {
                                ...
                                e.is(b.advanced.autoScrollOnFocus) && (G(a), clearTimeout(a[0]._focusTimeout), a[0]._focusTimer = d ? 17 * d : 0, a[0]._focusTimeout = setTimeout(function() {
                                    var c = [x(e)[0], x(e)[1]],
                    ...
                    wa = function() {
                        var a = c(this),
                            ...
                            e = d.sequential,
                            k = "mCS_" + d.idx;
                        c(".mCSB_" + d.idx + "_scrollbar>a").bind("contextmenu." +
                            k,
                            function(a) {
                                a.preventDefault()
                    ...
                    xa = function() {
                        function a(a) {
                            ...
                            switch (a.type) {
                                ...
                                case "keyup":
                                    ...
                                    var l = "on";
                                    if ("x" !== e.axis && (38 === h || 40 === h) || "y" !== e.axis && (37 === h || 39 === h))(38 !== h && 40 !== h || b.overflowed[0]) && (37 !== h && 39 !== h || b.overflowed[1]) && ("keyup" === a.type && (l = "off"), c(document.activeElement).is("input,textarea,select,datalist,keygen,[contenteditable='true']") || (a.preventDefault(), a.stopImmediatePropagation(), f(l, h)));
                                    else if (33 === h || 34 === h) {
                                        if (b.overflowed[0] || b.overflowed[1]) a.preventDefault(), a.stopImmediatePropagation();
                                        "keyup" === a.type && (G(d), h = 34 === h ? -1 : 1, "x" === e.axis || "yx" === e.axis && b.overflowed[1] && !b.overflowed[0] ? (a = "x", h = Math.abs(m[0].offsetLeft) - .9 * h * g.width()) : (a = "y", h = Math.abs(m[0].offsetTop) - .9 * h * g.height()), y(d, h.toString(), {
                                            dir: a,
                                            scrollEasing: "mcsEaseInOut"
                                        }))
                                        ...
                                        "keyup" === a.type && ("x" === e.axis || "yx" ===
                                            e.axis && b.overflowed[1] && !b.overflowed[0] ? (a = "x", h = 35 === h ? Math.abs(g.width() - m.outerWidth(!1)) : 0) : (a = "y", h = 35 === h ? Math.abs(g.height() - m.outerHeight(!1)) : 0), y(d, h.toString(), {
                                                dir: a,
                                                scrollEasing: "mcsEaseInOut"
                                            }))
                                    }
                        ...
                        l.length && l.each(function() {
                            c(this).bind("load", function() {
                                N(this) && c(this.contentDocument || this.contentWindow.document).bind(p[0],
                                    function(b) {
                                        a(b)
                                    })
                            })
                    ...
                    ba = function(a, d, b, e, k) {
                        function h(b) {
                            ...
                            var c = "stepped" !== g.type,
                                ...
                                v = "x" ===
                                g.dir[0] ? n[1] + g.dir[1] * parseInt(g.scrollAmount) : n[0] + g.dir[1] * parseInt(g.scrollAmount),
                            ...
                            b ? g.dir = !1 : (clearTimeout(g.step), g.step = setTimeout(function() {
                                h()
                            }, d))
                        }
                        var f = a.data("mCS"),
                        ...
                        switch (d) {
                            case "on":
                                ...
                                G(a);
                                if (U(b) && "stepped" === g.type) break;
                                h(p);
                                break;
                            case "off":
                                clearTimeout(g.step), F(g, "step"), G(a), (p || f.tweenRunning && g.dir) && h(!0)
                        }
                    },
                    Z = function(a) {
                        ...
                        a instanceof Array ? b = 1 < a.length ? [a[0], a[1]] : "x" === d.axis ? [null, a[0]] : [a[0], null] : (b[0] = a.y ? a.y : a.x || "x" === d.axis ? null : a, b[1] = a.x ? a.x : a.y || "y" === d.axis ? null :
                            a);
                    ...
                    ga = function(a, d) {
                        if (null != a && "undefined" !== typeof a) {
                            ...
                            switch (f) {
                                ...
                                case "string":
                                case "number":
                                    if (U(a)) return Math.abs(a);
                                    if (-1 !== a.indexOf("%")) return Math.abs(k * parseInt(a) / 100);
                                    if (-1 !== a.indexOf("-=")) return Math.abs(m - parseInt(a.split("-=")[1]));
                                    if (-1 !== a.indexOf("+=")) return d = m + parseInt(a.split("+=")[1]), 0 <= d ? 0 : Math.abs(d);
                                    if (-1 !== a.indexOf("px") && U(a.split("px")[0])) return Math.abs(a.split("px")[0]);
                                    if ("top" === a || "left" === a) return 0;
                                    if ("bottom" === a) return Math.abs(h.height() - e.outerHeight(!1));
                                    if ("right" ===
                                        a) return Math.abs(h.width() - e.outerWidth(!1));
                                    if ("first" === a || "last" === a) return a = e.find(":" + a), "x" === d ? x(a)[1] : x(a)[0];
                                    if (c(a).length) return "x" === d ? x(c(a))[1] : x(c(a))[0];
                                    e.css(g, a);
                    ...
                    Y = function(a) {
                        function d() {
                            ...
                            0 === h.parents("html").length ? h = null : g[0].autoUpdate = setTimeout(function() {
                                if (m.advanced.updateOnSelectorChange && (f.poll.change.n = e(), f.poll.change.n !== f.poll.change.o)) {
                                    f.poll.change.o = f.poll.change.n;
                                    k(3);
                                    return
                                }
                                if (m.advanced.updateOnContentResize &&
                                    (f.poll.size.n = h[0].scrollHeight + h[0].scrollWidth + g[0].offsetHeight + h[0].offsetHeight + h[0].offsetWidth, f.poll.size.n !== f.poll.size.o)) {
                                    f.poll.size.o = f.poll.size.n;
                                    k(1);
                                    return
                                }
                                if (m.advanced.updateOnImageLoad && ("auto" !== m.advanced.updateOnImageLoad || "y" !== m.axis) && (f.poll.img.n = g.find("img").length, f.poll.img.n !== f.poll.img.o)) {
                                    f.poll.img.o = f.poll.img.n;
                                    g.find("img").each(function() {
                                        b(this)
                                    });
                                    return
                                }(m.advanced.updateOnSelectorChange || m.advanced.updateOnContentResize || m.advanced.updateOnImageLoad) &&
                                d()
                            }, m.advanced.autoUpdateTimeout)
                        }

                        function b(a) {
                            if (c(a).hasClass(n[2])) k();
                            else {
                                var b = new Image;
                        ...
                        a ? (clearTimeout(g[0].autoUpdate), F(g[0], "autoUpdate")) : d()
                    },
                    G = function(a) {
                        a = a.data("mCS");
                        c("#mCSB_" + a.idx + "_container,#mCSB_" + a.idx + "_container_wrapper,#mCSB_" + a.idx + "_dragger_vertical,#mCSB_" + a.idx + "_dragger_horizontal").each(function() {
                            ...
                            for (var a = ["top", "left"], b = 0; b < a.length; b++) {
                                var c = a[b];
                                this._mTween[c].id && (window.requestAnimationFrame ? window.cancelAnimationFrame(this._mTween[c].id) :
                                    clearTimeout(this._mTween[c].id), this._mTween[c].id = null, this._mTween[c].stop = 1)
                            }
                        })
                    },
                    y = function(a, d, b) {
                        ...
                        function k() {
                            ...
                            a[0].mcs = {
                                ...
                                leftPct: Math.round(100 * Math.abs(c[1]) / (Math.abs(e[1]) -
                                    f[1])),
                                direction: b.dir
                            }
                        }
                        ...
                        h.trigger = b.trigger;
                        if (0 !== p.scrollTop() || 0 !== p.scrollLeft()) c(".mCSB_" + h.idx + "_scrollbar").css("visibility", "visible"), p.scrollTop(0).scrollLeft(0);
                        "_resetY" !== d || h.contentReset.y || (e("onOverflowYNone") && f.callbacks.onOverflowYNone.call(a[0]), h.contentReset.y = 1);
                        "_resetX" !== d || h.contentReset.x || (e("onOverflowXNone") && f.callbacks.onOverflowXNone.call(a[0]), h.contentReset.x = 1);
                        if ("_resetY" !== d && "_resetX" !== d) {
                            !h.contentReset.y && a[0].mcs || !h.overflowed[0] || (e("onOverflowY") && f.callbacks.onOverflowY.call(a[0]), h.contentReset.x =
                                null);
                            !h.contentReset.x && a[0].mcs || !h.overflowed[1] || (e("onOverflowX") && f.callbacks.onOverflowX.call(a[0]), h.contentReset.x = null);
                            f.snapAmount && (p = f.snapAmount instanceof Array ? "x" === b.dir ? f.snapAmount[1] : f.snapAmount[0] : f.snapAmount, d = Math.round(d / p) * p - f.snapOffset);
                            switch (b.dir) {
                                case "x":
                                    ...
                                    var w = u[1];
                                    var x = 0 <
                                        q ? q / h.scrollRatio.x : 0;
                                    var R = 0 < w ? w / h.scrollRatio.x : 0;
                                    break;
                                case "y":
                                    v = c("#mCSB_" + h.idx + "_dragger_vertical"), r = "top", D = l[0].offsetTop, t = [g.height() - l.outerHeight(!1), v.parent().height() - v.height()], z = [d, 0 === d ? 0 : d / h.scrollRatio.y], q = n[0], w = u[0], x = 0 < q ? q / h.scrollRatio.y : 0, R = 0 < w ? w / h.scrollRatio.y : 0
                            }
                            0 > z[1] || 0 === z[0] && 0 === z[1] ? z = [0, 0] : z[1] >= t[1] ? z = [t[0], t[1]] : z[0] = -z[0];
                            a[0].mcs || (k(), e("onInit") && f.callbacks.onInit.call(a[0]));
                            ...
                            !h.tweenRunning && (0 === D && 0 <= z[0] || D === t[0] && z[0] <= t[0]) || ja(l[0], r, Math.round(z[0]), m[0], b.scrollEasing, b.overwrite, {
                                onStart: function() {
                                    b.callbacks && b.onStart && !h.tweenRunning && (e("onScrollStart") && (k(), f.callbacks.onScrollStart.call(a[0])), h.tweenRunning = !0, W(v), h.cbOffsets = [f.callbacks.alwaysTriggerOffsets || D >= t[0] + q, f.callbacks.alwaysTriggerOffsets || D <= -w])
                                },
                                onUpdate: function() {
                                    b.callbacks && b.onUpdate && e("whileScrolling") && (k(), f.callbacks.whileScrolling.call(a[0]))
                                },
                                onComplete: function() {
                                    b.callbacks &&
                                        b.onComplete && ("yx" === f.axis && clearTimeout(l[0].onCompleteTimeout), l[0].onCompleteTimeout = setTimeout(function() {
                                            e("onScroll") && (k(), f.callbacks.onScroll.call(a[0]));
                                            e("onTotalScroll") && z[1] >= t[1] - x && h.cbOffsets[0] && (k(), f.callbacks.onTotalScroll.call(a[0]));
                                            e("onTotalScrollBack") && z[1] <= R && h.cbOffsets[1] && (k(), f.callbacks.onTotalScrollBack.call(a[0]));
                                            h.tweenRunning = !1;
                                            l[0].idleTimer = 0;
                                            W(v, "hide")
                                        }, l[0].idleTimer || 0))
                    ...
                    ja = function(a, c, b, e, k, h, f) {
                        function d() {
                            w.stop || (q || n.call(), q = S() - v, g(), q >=
                                w.time && (w.time = q > w.time ? q + r - (q - w.time) : q + r - 1, w.time < q + 1 && (w.time = q + 1)), w.time < e ? w.id = y(d) : u.call())
                        }

                        function g() {
                            0 < e ? (w.currVal = l(w.time, x, A, e, k), z[c] = Math.round(w.currVal) + "px") : z[c] = b + "px";
                            t.call()
                        }
                        ...
                        var A = b - x;
                        w.stop = 0;
                        "none" !== h && null != w.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(w.id) : clearTimeout(w.id), w.id = null);
                        (function() {
                            r = 1E3 / 60;
                            w.time = q + r;
                    ...
                    S = function() {
                        return window.performance && window.performance.now ? window.performance.now() : window.performance && window.performance.webkitNow ? window.performance.webkitNow() : Date.now ? Date.now() :
                            (new Date).getTime()
                    },
                    F = function(a, c) {
                        try {
                ...
                c.fn.mCustomScrollbar = function(a) {
                    ...
                    if ("object" !== ("undefined" === typeof a ? "undefined" : r(a)) && a) c.error("Method " + a + " does not exist");
                    else return C.init.apply(this, arguments)
                };
                c.mCustomScrollbar = function(a) {
                    if (C[a]) return C[a].apply(this, Array.prototype.slice.call(arguments, 1));
                    if ("object" !== ("undefined" === typeof a ? "undefined" : r(a)) && a) c.error("Method " + a + " does not exist");
                    else return C.init.apply(this,
                        arguments)
                };
                ...
                c(window).bind("load", function() {
                    ...
                    c.extend(c.expr[":"], {
                        ...
                        mcsOverflow: c.expr[":"].mcsOverflow || function(a) {
                            if (a = c(a).data("mCS")) return a.overflowed[0] || a.overflowed[1]
                        }
                    })
                })
            })()
...
(function(l, a) {
    if ("object" === typeof exports && "object" === typeof module) module.exports = a();
        ...
        a = a();
        for (var h in a)("object" === typeof exports ? exports : l)[h] = a[h]
    }
})("undefined" !== typeof self ? self : this, function() {
    return function(l) {
        function a(b) {
            if (h[b]) return h[b].exports;
            var f = h[b] = {
                i: b,
                l: !1,
                exports: {}
        ...
        (function(b) {
            function a(c) {
                ...
                "wheelDeltaX" in
                d && (g = -1 * d.wheelDeltaX);
                "axis" in d && d.axis === d.HORIZONTAL_AXIS && (g = -1 * e, e = 0);
                var m = 0 === e ? g : e;
                "deltaY" in d && (m = e = -1 * d.deltaY);
                "deltaX" in d && (g = d.deltaX, 0 === e && (m = -1 * g));
                if (0 !== e || 0 !== g) {
                    if (1 === d.deltaMode) {
                        ...
                        e *= k;
                        g *= k
                    } else 2 === d.deltaMode && (k = b.data(this, "mousewheel-page-height"), m *= k, e *= k, g *= k);
                    k = Math.max(Math.abs(e), Math.abs(g));
                    if (!n || k < n) n = k, p.settings.adjustOldDeltas && "mousewheel" === d.type && 0 === k % 120 && (n /= 40);
                    p.settings.adjustOldDeltas && "mousewheel" ===
                        d.type && 0 === k % 120 && (m /= 40, g /= 40, e /= 40);
                    m = Math[1 <= m ? "floor" : "ceil"](m / n);
                    g = Math[1 <= g ? "floor" : "ceil"](g / n);
                    e = Math[1 <= e ? "floor" : "ceil"](e / n);
                    p.settings.normalizeOffset && this.getBoundingClientRect && (d = this.getBoundingClientRect(), f = c.clientX - d.left, l = c.clientY - d.top);
                    c.deltaX = g;
                    c.deltaY = e;
                    c.deltaFactor = n;
                    c.offsetX = f;
            ...
            var l = ["wheel", "mousewheel",
                ...
                n = void 0;
            if (b.event.fixHooks)
                for (var t = l.length; t;) b.event.fixHooks[l[--t]] = b.event.mouseHooks;
            var p = b.event.special.mousewheel = {
                version: "3.1.12",
                setup: function() {
                    if (this.addEventListener)
                        for (var c = q.length; c;) this.addEventListener(q[--c], a, !1);
                ...
                teardown: function() {
                    if (this.removeEventListener)
                        for (var c = q.length; c;) this.removeEventListener(q[--c], a, !1);
