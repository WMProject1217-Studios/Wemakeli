...
var Sentry = function(n) {
    ...
    var W = function() {
        ...
        X = function() {
            function n() {
                this.D = !1, this.I = [], this.N = [], this.A = [], this.C = {}, this.L = {}, this.M = {}, this.F = {}
            }
            return n.prototype.addScopeListener = function(n) {
                ...
                return this.C = C(n), this.U(), this
            }, n.prototype.setTags = function(n) {
                return this.L = u({}, this.L, C(n)), this.U(), this
            }, n.prototype.setTag = function(n, t) {
                var r;
                return this.L = u({}, this.L, ((r = {})[n] = C(t), r)), this.U(), this
            }, n.prototype.setExtras = function(n) {
                return this.M = u({}, this.M, C(n)), this.U(), this
            }, n.prototype.setExtra = function(n, t) {
                var r;
                return this.M = u({}, this.M, ((r = {})[n] = C(t), r)), this.U(), this
            }, n.prototype.setFingerprint = function(n) {
                return this.$ = C(n), this.U(), this
            }, n.prototype.setLevel = function(n) {
                return this.q = C(n), this.U(), this
            }, n.prototype.setTransaction = function(n) {
                return this.H = n, this.U(), this
            }, n.prototype.setContext = function(n, t) {
                return this.F[n] = t ? C(t) : void 0, this.U(), this
            }, n.prototype.setSpan = function(n) {
                return this.W = n, this.U(), this
                ...
                return Object.assign(r, t, {
                    I: []
                }), t && (r.A = s(t.A), r.L = u({}, t.L), r.M = u({}, t.M), r.F = u({}, t.F), r.C = t.C, r.q = t.q, r.W = t.W, r.H = t.H, r.$ = t.$, r.N = s(t.N)), r
            }, n.prototype.clear = function() {
                return this.A = [], this.L = {}, this.M = {}, this.C = {}, this.F = {}, this.q = void 0, this.H = void 0, this.$ = void 0, this.W = void 0, this.U(), this
            }, n.prototype.addBreadcrumb = function(n, t) {
                var r = (new Date).getTime() / 1e3,
                    e = u({
                        timestamp: r
                    }, n);
                return this.A = void 0 !== t && t >= 0 ? s(this.A, [C(e)]).slice(-t) : s(this.A, [C(e)]), this.U(), this
    ...
    var hn, ln = function() {
            ...
            return n.prototype.captureException = function(n, t, r) {
                ...
                var l = f.request;
                l && l.url && (l.url = F(l.url, a)), void 0 === f.event_id && (f.event_id = w()), this.vn(f.sdk);
                var v = W.resolve(f);
    ...
    var An, Cn, Ln = function() {
        ...
        $n = function(t) {
            ...
            return r(e, t), e.prototype.mn = function() {
                ...
                var e, i, o = this;
                if (h(t) && t.error) return t = t.error, e = In(Tn(t)), W.resolve(this.Cn(e, r));
                if (l(t) || (i = t, "[object DOMException]" === Object.prototype.toString.call(i))) {
                    ...
                    return this.eventFromMessage(s, n.Severity.Error, r).then(function(n) {
                        return x(n, s), W.resolve(o.Cn(n, r))
                    })
                }
                if (f(t)) return e = In(Tn(t)), W.resolve(this.Cn(e, r));
                if (p(t) && r && r.syntheticException) return x(e = function(n, t) {
                    ...
                    synthetic: !0,
                    type: "generic"
                }), e.level = n.Severity.Error, W.resolve(this.Cn(e, r));
                var a = t;
                return this.eventFromMessage(a, void 0, r).then(function(t) {
                    return x(t, "" + a, void 0, {
                        ...
                        synthetic: !0,
                        type: "generic"
                    }), t.level = n.Severity.Error, W.resolve(o.Cn(t, r))
                })
    ...
    var Zn = function() {
            ...
            return n.prototype.setupOnce = function() {
                ...
                return x(r, n.original ? F(JSON.stringify(C(n.original)), o) : "", "onunhandledrejection" === n.mechanism ? "UnhandledRejection" : "Error", {
                    data: e,
                    handled: !1,
                    type: n.mechanism
                }), r
                ...
                "console" in tt && ["debug", "info", "warn", "error", "log", "assert"].forEach(function(r) {
                    r in tt.console && R(tt.console, r, function(e) {
                        return function() {
                            ...
                            "assert" === r && !1 === i[0] && (u.message = "Assertion failed: " + (U(i.slice(1), " ") || "console.assert"), u.data.extra.arguments = C(i.slice(1), 3)), t.addBreadcrumb(u, {
                                input: i,
                                level: r
    ...
    var vt = u({}, ht, bn, at);
    return n.BrowserClient = Hn, n.Hub = K, n.Integrations = vt, n.SDK_NAME = qn, n.SDK_VERSION = "5.2.1", n.Scope = X, n.Transports = Pn, n.addBreadcrumb = function(n) {
        en("addBreadcrumb", n)
