...
! function(e, t) {
    ...
    return function(e) {
        function t(t) {
            for (var o, a, s = t[0], u = t[1], f = t[2], l = 0, d = []; l < s.length; l++) a = s[l], Object.prototype.hasOwnProperty.call(i, a) && i[a] && d.push(i[a][0]), i[a] = 0;
        ...
        260: function(e, t, n) {
            ...
            var o = n(10),
                i = n.n(o),
                r = (n(176), n(43), n(106), n(46), n(18), n(54), n(5), n(13), n(69), n(142), n(70), n(2)),
                a = n.n(r),
                s = (n(40), n(6)),
                u = n(56),
                f = n.n(u);
            ...
            var d = {
                    ...
                    methods: {
                        getUid: function() {
                            var e = this;
                            return f.a.get().then((function(t) {
                                e.uid = t.data.mid
                            }))
                        },
                            ...
                            return l(a.a.mark((function n() {
                                ...
                                return a.a.wrap((function(n) {
                                    for (;;) switch (n.prev = n.next) {
                                        case 0:
                                            o = e.length > 0 && void 0 !== e[0] && e[0], i = function() {
                                                var e = l(a.a.mark((function e() {
                                            ...
                                            }(), o ? i() : parseInt(localStorage.getItem("unreadApiRequestedBy".concat(t.uid, "At"))) + 6e4 > Date.now() ? (r = JSON.parse(localStorage.getItem("imNotifyCounts".concat(t.uid))) || {}, t.notifyCounts.message = parseInt(r.message) || 0) : i();
                                        case 3:
                                        case "end":
                                            return n.stop()
                                    }
