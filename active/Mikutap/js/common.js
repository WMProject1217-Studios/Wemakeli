...
hr.indexOf("nore=1") <= 0 && 0 < hr.indexOf("a.aidn") && (location.href = hr.split("a.aidn").join("aidn")), 0 < hr.indexOf("www.aidn") && (location.href = hr.split("www.aidn").join("aidn")),
    function(e, t, n, i, a, o) {
        e.GoogleAnalyticsObject = i, e.ga = e.ga || function() {
            (e.ga.q = e.ga.q || []).push(arguments)
        }, e.ga.l = +new Date, a = t.createElement(n), o = t.getElementsByTagName(n)[0], a.async = 1, a.src = "", o.parentNode.insertBefore(a, o)
    }(window, document, "script", "ga"), ga("create", "UA-27113912-1", "auto"), ga("send", "pageview");
var aidn = aidn || {};
aidn.log = function() {
...
aidn.init = {
    ...
    selectBasePath: function(e, t) {
        var n = parseInt(aidn.util.getCookie("baseid")),
            e = e;
        return !isNaN(n) && 1 != t || (n = Math.floor(Math.random() * e.length), aidn.util.setCookie("baseid", n, 604800)), (e.length <= n || n < 0) && (n = 0), this.basepath = e[n], this.basepath
    },
    loadScript: function(n, i) {
        ...
        var a = function(e) {
            ...
            aidn.init.usebase && 0 != t.indexOf("http") && (t = aidn.init.basepath + t), $.getScript(t, function() {
    ...
    init: function() {
        this.clWidth = document.documentElement.clientWidth, this.clHeight = document.documentElement.clientHeight, this.scWidth = screen.width, this.scHeight = screen.height, this.inWidth = window.innerWidth, this.inHeight = window.innerHeight, (this.clHeight <= 0 || this.clWidth <= 0) && (this.clWidth = this.scWidth, this.clHeight = this.scHeight), (this.inHeight <= 0 || this.inWidth <= 0) && (this.inWidth = this.clWidth, this.inHeight = this.clHeight)
    },
    clWidth: 0,
    clHeight: 0,
    scWidth: 0,
    ...
    create: function(e, t, n, i, a) {
        ...
        document.getElementById(e).innerHTML = o, this.canvas = document.getElementById(t), this.ctx = this.canvas.getContext("2d"), this.w = n, this.h = i, this.bgColor = a, this.clear(!0)
    },
    clear: function(e) {
    ...
    addTouchEvent: function(e, t, n, i, a) {
        "string" == typeof e && (e = document.getElementById(e)), t && e.addEventListener("touchstart", t, !1), n && e.addEventListener("touchmove", n, !1), i && e.addEventListener("touchend", i, !1), a && e.addEventListener("touchcancel", a, !1)
    },
    removeTouchEvent: function(e, t, n, i, a) {
        "string" == typeof e && (e = document.getElementById(e)), t && e.removeEventListener("touchstart", t, !1), n && e.removeEventListener("touchmove", n, !1), i && e.removeEventListener("touchend", i, !1), a && e.removeEventListener("touchcancel", a, !1)
    },
    addMouseEvent: function(e, t, n, i, a) {
        "string" == typeof e && (e = document.getElementById(e)), t && e.addEventListener("mousedown", t, !1), n && e.addEventListener("mousemove", n, !1), i && e.addEventListener("mouseup", i, !1), a && e.addEventListener("mouseout", a, !1)
    },
    removeMouseEvent: function(e, t, n, i, a) {
        "string" == typeof e && (e = document.getElementById(e)), t && e.removeEventListener("mousedown", t, !1), n && e.removeEventListener("mousemove", n, !1), i && e.removeEventListener("mouseup", i, !1), a && e.removeEventListener("mouseout", a, !1)
    },
    ...
    copyToClipboard: function(e) {
        ...
        e = t.style;
        e.position = "fixed", e.left = "-100%", document.body.appendChild(t), t.focus();
        e = document.execCommand("copy");
        return t.blur(), document.body.removeChild(t), e
    },
    getCookie: function(e) {
        var t = null,
            ...
            i = document.cookie,
            e = i.indexOf(n);
        return 0 <= e && (-1 == (n = i.indexOf(";", e = e + n.length)) && (n = i.length), t = decodeURIComponent(i.substring(e, n))), t
    },
    setCookie: function(e, t, n, i) {
        t = e + "=" + encodeURIComponent(t) + ";";
        0 <= n && (t += " max-age=" + n + ";"), i && (t += " path=" + i + ";"), document.cookie = t
    },
    ...
    setStorage: function(e, t) {
        void 0 === t && (t = location.href.split("/")[3]), "object" == typeof e && (e = JSON.stringify(e)), localStorage.setItem(t, e)
    },
    needExpandArea: function(e) {
        var t = navigator.userAgent,
            n = 0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod");
        return (n = n && 0 <= t.indexOf("Version/") && Math.max(window.screen.width, window.screen.height) < 600) && 1 == e && (window.scrollTo(0, 0), $("body").css("padding-bottom", 1)), n
    },
    ...
    resize: function(e, t) {
        void 0 === (aidn.window._isFit = t) && (aidn.window._isFit = !0), aidn.window._resizeFunc = e, $(window).resize(aidn.window._resize), aidn.window._isFit && aidn.window.scrollOff(), aidn.window._isTwitteriOS && aidn.window._resizeFix(), aidn.window._resize()
    },
    width: function() {
        return $(window).width()
    },
    ...
    reloadTw: function(e, t, n, i) {
        ...
        e && (a += ' data-text="' + e + '"'), t && (a += 'data-related="' + t + '"'), n && (a += 'data-count="' + n + '"'), i && (a += 'data-url="' + i + '"'), a += ' data-lang="en">Tweet</a>', $("#twitter").append(a), this.initTw()
    },
    shareTw: function(e, t, n, i, a) {
        var o = "https://twitter.com/intent/tweet",
            r = {};
        e && (r.url = encodeURIComponent(e)), n && (r.text = encodeURIComponent(n)), i && (r.related = i), a && (r.hashtags = encodeURIComponent(a));
        var d, s = 0;
        for (d in r) o += 0 == s ? "?" + d + "=" + r[d] : "&" + d + "=" + r[d], s++;
...
function __addRelease(e, t, n, i, a, o, r, d) {
    if ("string" != typeof(d = void 0 === d ? null : d) || "1" != aidn.util.getCookie(d = "_release" + d)) {
        "string" != typeof a && (a = "New Release"), "string" != typeof o && (o = "New Release"), _isJapanese || (a = o);
        for (var s = "Noto+Sans+JP:wght@500", l = !1, c = "Poppins:wght@500", u = !1, h = $("link"), f = 0, g = h.length; f < g; f++) {
            var p = h[f].getAttribute("href");
            p && (0 < p.indexOf(s) && (l = !0), 0 < p.indexOf(c) && (u = !0))
        }
        l && u || (v = '', l || (v += s), l || u || (v += ""), u || (v += c), v += '', $("head").append(v)), _isJapanese || (n = i);
        var m = Date.now() + Math.floor(1e5 * Math.random()),
            v = "calc(0.7rem + 0.7vh)";
        24 <= n.length && (v = "calc(0.6rem + 0.6vh)");
        i = "bottom", i = "white-space: nowrap; position: fixed; " + (i = 1 == r ? "top" : i) + ": -2px; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #000; background:rgba(247, 247, 247, 0.95); text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1; border: solid 1px #000000;", i = '<div id="rel_open' + m + '" style="' + (i += "font-family:Poppins,'Noto Sans JP','游ゴシック','Yu Gothic','游ゴシック体',YuGothic,'Yu Gothic UI','ヒラギノ角ゴ Pro W3','Hiragino Kaku Gothic Pro','Meiryo UI','メイリオ',Meiryo,sans-serif;") + '">';
        i += '<img src="' + e + '" style="width:calc(50px + 3vh); height:calc(50px + 3vh); margin: calc(5px + 1vh); vertical-align:middle; border:1px solid #333;">', i += '<p style="display:inline-block; vertical-align:middle; letter-spacing:0.11rem; line-height:1.5; font-weight:500;">', i += '<span style="font-size:calc(0.5rem + 0.6vh); color: #f40;" class="blink">' + a + "</span><br>", i += '<span style="font-size:' + v + ';">' + n + "</span>", i += "</p>", i += '<p id="rel_close' + m + '" style="position:absolute; right:1vh; top:1vh;">', i += '<svg style="width: calc(24px + 2vmin);" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>', i += "</p>", i += "</div>", $("body").append(i), i = "<style>\n.blink{\n", i += "-webkit-animation: animFade 0.7s ease-in infinite alternate;\n", i += "animation: animFade 0.7s ease-in infinite alternate;\n", i += "}\n", i += "@-webkit-keyframes animFade {\n 20% { opacity: 1; }\n 100% { opacity: 0.2; } \n}\n", i += "@keyframes animFade {\n 20% { opacity: 1; }\n 100% { opacity: 0.2; } \n}\n", i += "</style>", $("head").append(i), $("#rel_open" + m).on("click", function(e) {
            e.preventDefault(), location.href = t
        }), $("#rel_close" + m).on("click", function(e) {
            e.preventDefault(), e.stopPropagation(), $("#rel_open" + m).hide(), d && aidn.util.setCookie(d, "1", 86400, "/")
        })
    }
}
...
function __checkInit() {
    ...
    "undefined" == typeof jQuery ? setTimeout(__checkInit, 10) : ((e = window.__s) && "string" == typeof e && ($.ajax({
        ...
        $("meta[name='theme-color']").length <= 0 && $("meta:last").after('<meta name="theme-color" content="#000000">'), aidn.util.initStandAlone();
        var e = aidn.util.getiOSVersion();
        8 <= e && e < 14 && aidn.util.checkStandAlone() && (b = "_start_url", localStorage.getItem(b) || localStorage.setItem(b, location.href), document.addEventListener("visibilitychange", function(e) {
        ...
        if ((0 < a.indexOf("MSIE") || 0 < a.indexOf("rv:11.0")) && 0 < $("svg").length && (i = -1, $(window).resize(function() {
                clearTimeout(i), i = setTimeout(r, 200)
            ...
            1 != $("body").data("motion") || 2 <= (h = location.href.split("aidn")).length && (c = !0, o = h[1].split("/").length - 3), c && (d = setTimeout(function() {
                var e = "";
                ...
                e += '<img src="' + n + '" style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:100%; height:100%; max-width:640px; object-fit: contain;">', e += "</div>";
                var a = $(e);
                a.fadeIn("normal"), a.on("click", function() {
                    13 <= aidn.util.getiOSVersion() && DeviceMotionEvent.requestPermission(), a.fadeOut("normal")
                }), $("body").append(a)
            }, 500), window.addEventListener("deviceorientation", function e(t) {
                clearTimeout(d), window.removeEventListener("deviceorientation", e)
            }))
        }
        ...
        _isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function() {
            ...
            var i = "none" != $("#google_translate_element").attr("data-bar"),
                a = "<style>";
            a += ".goog-te-gadget { margin-top:10px; margin-bottom:10px; }", a += ".goog-te-gadget a:link, .goog-te-gadget a:visited { text-decoration:none; }", a += "div.skiptranslate { opacity: 0; }", a += "#google_translate_element div.skiptranslate { opacity: 1; letter-spacing:0.12rem; } ", a += "#google_translate_element .goog-te-gadget-simple { padding: 6px; } ", i || (a += ".goog-te-banner-frame { display: none; } ", $("body").css({
                top: 0
            })), a += "</style>", $("head").append(a);
        ...
        for (var h, f = !1, g = "New Release (^._.^)/", p = "New Release (^._.^)/", m = "nyancat10th/", v = "daniwell/shared/img/jacket/nyancat_arrangements.png", w = "Nyan Cat Arrangements", y = "Nyan Cat Arrangements", s = [{
                path: "/shake/"
            }, {
                path: "/swipe/"
            }, {
            ...
            if (0 < l.indexOf(_.path)) {
                c = !0, b = "_sub", _.key && (b = _.key), _.desc && (g = _.desc, p = _.desc), _.descEn && (p = _.descEn), _.link && (m = _.link), _.imgPath && (v = _.imgPath), _.title && (w = _.title, y = _.title), _.titleEn && (y = _.titleEn), "boolean" == typeof _.topFlag && (f = _.topFlag);
                break
            }
        }
        if (0 < $("#aidnx").length || c) {
            /*for (var x = (l = (0 <= (l = location.href.split("#")[0].split("?")[0]).indexOf("MikuTap/") ? l.split("MikuTap/") : l.split("MikuTap/"))[1]).split("/").length, k = "", n = 0; n < x - 1; n++) k += "../";
            __addRelease(v = v.indexOf("http") < 0 ? k + v : v, m = m.indexOf("http") < 0 ? k + m : m, w, y, g, p, f, b)*/
        }
        0 < $("#aidn").length && (_active = !1), 0 < $("#aidnx").length && (_active = !1, $("#bt_menu").on("click", function() {
    ...
    initSnsButtons: function(t, n) {
        0 <= t.indexOf("http://aidn.jp") && (t = t.replace("http", "https")), $("#sns_tw").click(function(e) {
    ...
    var o, r, d, a, s, t, l = this,
        c = new Audio,
        n = 1;
    (this._audio = c).addEventListener("playing", function() {
        ...
        isNaN(n) || (n = null), i && (n = i);
        e = aidn.audio.getPath(e = "string" == typeof e ? [e] : e);
        if (!e) return !1;
        a = t, c.src = e, c.onprogress = function() {
            try {
                n && n(c.buffered.end(0) / c.duration)
            } catch (e) {}
        }, c.load()
    }, this.play = function(t, e, n, i, a) {
        void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === a && (a = 1), s = n, d = e = void 0 === e ? !1 : e, r = 1e6;
        try {
            c.currentTime = t
        } catch (e) {
            aidn.log(e), o = t
        }
        c.play(), 0 < i && "undefined" != typeof jQuery ? (l.volume = 0, $(l).stop().animate({
            volume: a
        }, 1e3 * i, "easeInSine")) : l.volume = a
    }, this.pause = function() {
        c.pause()
    }, this.playSprite = function(e, t) {
        c.currentTime = e, c.play(), r = t
    ...
    if (void 0 !== aidn.___waContext) this._context = I = aidn.___waContext;
        ...
        this._context = I, aidn.___waContext = I
    }
    ...
    this.load = function(e, u, t, n) {
        ...
        if (0 <= t && (A = t), "string" == typeof e)
            if (0 < e.indexOf("base64"))
                for (var i = !0, a = atob(e.split(",")[1]), o = a.length, r = new Uint8Array(o), d = 0; d < o; ++d) r[d] = a.charCodeAt(d);
            else e = [e];
        if (0 < e[0].indexOf("blank.mp3") && (t = new Audio(e[0]), document.body.appendChild(t)), !I) return !1;
        I.createBufferSource().start(0), h = null;
        ...
        function l() {
            ...
            I.decodeAudioData(e, function(e) {
                if (0 <= A) {
                    for (var t = A, n = Number.MAX_VALUE, i = e.numberOfChannels, a = 0; a < i; a++) {
                        for (var o = e.getChannelData(a), r = o.length, d = 0; d < r && !(t < Math.abs(o[d])); d++);
                        d < n && (n = d)
                    }
                    for (var r = e.length - n, s = I.createBuffer(i, r, I.sampleRate), a = 0; a < i; a++)
                        for (var l = e.getChannelData(a), c = s.getChannelData(a), d = 0; d < r; d++) c[d] = l[d + n];
                    e = s
                }
                S = (h = e).duration, u && u(h), F && (F = !1, x.play(m, v, w, y, b, _))
            }, function() {})
        }
    }, this.play = function(e, t, n, i, a, o) {
        if (m = e, v = t, w = n, y = i, b = a, _ = o, !h) return F = !0, void console.log('call "load" method before "play"');
        void 0 === e && (e = 0), void 0 === t && (t = !1), void 0 === i && (i = 0), void 0 === a ? a = T : T = a, void 0 === o && (o = 0), (u = I.createBufferSource()).buffer = h, u.loop = t, u.onended = L, g = g || I.createGain();
        var r, d = [u, g];
        f && d.push(f), p && d.push(p);
        for (var s = 1; s < d.length; s++) l = d[s - 1], r = d[s], l.connect(r);
        for (var l = r, s = 0; s < k.length; s++) E[s] ? (l.connect(k[s]), l = k[s]) : (r.connect(k[s]), r = k[s]);
        for (var c, s = k.length - 1; 0 <= s; s--)
            if (!E[s]) {
                r.connect(I.destination);
                break
            }
        s < 0 && r.connect(I.destination), u.start ? u.start(I.currentTime + o, e) : u.noteOn(e), O = I.currentTime - e, this._source = u, this.nodeGain = g, 0 < i && "undefined" != typeof jQuery ? (x.volume = 0, $(x).stop().animate({
            volume: a
        }, 1e3 * i, "easeInSine")) : x.volume = a, n && (c = setInterval(function() {
        ...
        return 0 < (e = void 0 === e || e <= 0 ? "equalpower" : e) && (e = "HRTF"), (f = I.createPanner()).panningModel = e, this.nodePanner = f
    }, this.initBiquadFilter = function(e) {
        return void 0 === e && (e = 0), (p = I.createBiquadFilter()).type = e, p
    ...
    var i, a, o, r, d = 2;
    "undefined" != typeof swfobject && swfobject.hasFlashPlayerVersion(10) && null != e ? d = 0 : aidn.util.webaudio && (d = 1), ___flash_audioLoadComplete = function() {
        a()
        ...
        if ("string" == typeof arguments[0] && (arguments[0] = [arguments[0]]), 0 == d) {
            for (this.audio = i, t = 0; t < arguments[0].length; t++)
        ...
        0 == d && arguments[2] && (o = arguments[2], arguments[2] = "___flash_audioPlay"), (i.playFunc || i.play).apply(i, arguments)
    }, this.stop = function() {
